...
export async function getWelcomeChannel(
    client,
    guildId
) {
    const key = `welcome_${guildId}`;
...
export async function getLeaveChannel(
    client,
    guildId
) {
    const key = `leave_${guildId}`;
...
const BANNER_URL =
    'https://media.discordapp.net/attachments/1527750801462657095/1528001749179306034/server_er_banner.png?ex=6a8ecf05&is=6a8d7d85&hm=82cfdde9ca5670f2bac19279dbbd832088f07bb18d4e4096e2e46e7c35b1d581&=&format=webp&quality=lossless&width=1398&height=559';
